...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>VestaZK - Privacy-Preserving Lending on Starknet</title>
        <meta name="description" content="Borrow against BTC without revealing your position. MEV bots can't target you for liquidation." />
      </head>
